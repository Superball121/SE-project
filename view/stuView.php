...
<body>
<h1>申請表單</h1>
<form method="post" action="updaControl.php">
      ...
      父親: <input name="dad" type="text" id="dad" /> <br>
	    申請種類: <select  name="urgent" type="select" id="urgent" > 
					<option value='低收入戶'>低收入戶</option>
					<option value='中低收入戶'>中低收入戶</option>
					<option value='家庭突發因素'>家庭突發因素</option>
					</select>
	  <br>
    導師訪視內容：<textarea name="Content" id="tDes"></textarea><br>
    秘書審核內容：<textarea name="Content" id="sDes"></textarea><br>
